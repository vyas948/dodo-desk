      ...
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">DodoDesk</span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" onClick={() => setPlan('free')}
              ...
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-semibold text-gray-800 dark:text-white">Free Trial</span>
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Core ticketing included</p>
            </button>
            <button type="button" onClick={() => setPlan('pro')}
              ...
              <div className="absolute -top-2 right-3">
                <span className="text-xs bg-indigo-600 text-white px-2 py-0.5 rounded-full font-medium">Popular</span>
              </div>
              <div className="flex items-center justify-between mb-1">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">All features included</p>
            </button>
          </div>
          {plan === 'pro' && (
          ...
          <p className="text-xs text-center text-gray-400 dark:text-gray-500 mt-2">
            Need 6+ agents?{' '}
            <a href="mailto:sales@dododesk.com" className="text-indigo-600 dark:text-indigo-400 hover:underline">Contact us for Enterprise</a>
          </p>
        </div>
