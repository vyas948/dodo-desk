...
const PLANS = [
  {
    ...
    features: [
      ...
      'Asset tracking & CMDB up to 250 assets',
  ...
  },
  {
    ...
    features: [
      ...
      'Asset tracking & CMDB up to 1,000 assets',
  ...
  },
  {
    ...
    color: '#8b5cf6',
    lightBg: '#ede9fe',
    description: 'For mature IT teams following ITIL frameworks — change & problem management and AI native.',
    audience: 'ITIL teams',
  ...
  },
  {
    ...
    features: [
      ...
      'Sandbox environments *(coming soon)*',
      'Unlimited assets, CMDB & storage',
...
const COMPARE = [
  ...
  { feature: 'Custom branding & white label', essentials: true, business: true, pro: true, enterprise: true },
  ...
  { feature: 'CMDB — asset relationship mapping', essentials: true, business: true, pro: true, enterprise: true },
  ...
  { feature: 'Change & Problem management', essentials: false, business: false, pro: true, enterprise: true },
