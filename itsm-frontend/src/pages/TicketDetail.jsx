                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <Link to="/kb" target="_blank"
                            className="text-xs text-indigo-500 hover:text-indigo-700 dark:hover:text-indigo-300 flex items-center gap-1 border border-indigo-200 dark:border-indigo-700 px-2 py-0.5 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition">
